...
awful.util.tagnames = { "www", "dev", "chat", "music", "misc" }
...
globalkeys = mytable.join(
    ...
    -- X screen locker
    awful.key({ altkey, "Control" }, "q", function () os.execute("slock") end,
    ...
    -- Screen brightness
    awful.key({ }, "#72", function () os.execute("xbacklight -inc 10") end,
    ...
    awful.key({ }, "#68",
        ...
        {descrption = "volume down", group = "hotkeys"}),
    awful.key({ }, "#67",
        function ()
